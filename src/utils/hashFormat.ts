...
export const hashFormat = (amount: number | string, amountType: 'nhash' | 'hash' = 'nhash') => {
  ...
  const rawResult = amountType === 'nhash' ? floatedNumber * exponentialValue : (floatedNumber / exponentialValue);

import { completeHdPath } from 'utils/completeHdPath';
...
const testItems = [
  ...
  {
    partialHdPath: "m/44'/505'",
    addressIndex: '1',
    expectedResult: "m/44'/505'/0'/0/1",
  },
  {
    partialHdPath: "m/44'/505'/0'",
    addressIndex: '1',
    expectedResult: "m/44'/505'/0'/0/1",
  },
  {
    partialHdPath: "m/44'/505'/0'/0",
    addressIndex: '1',
    expectedResult: "m/44'/505'/0'/0/1",
  },
  {
    partialHdPath: "m/44'/505'/0'/0/1",
    addressIndex: '1',
    expectedResult: "m/44'/505'/0'/0/1",
  },
  {
    partialHdPath: "m/44'/505'/0'/0/1/0",
    addressIndex: '1',
    expectedResult: "m/44'/505'/0'/0/1/0",
  },
  // AddressIndex 1'
  { partialHdPath: 'm', addressIndex: "1'", expectedResult: "m/44'/505'/0'/0/1'" },
  {
  ...
  { partialHdPath: "m/44'", addressIndex: '1', expectedResult: "m/44'/505'/0'/0/1" },
  {
    partialHdPath: "m/44'/1'",
    addressIndex: '1',
    expectedResult: "m/44'/1'/0'/0/1",
  },
  {
    partialHdPath: "m/44'/1'/0'",
    addressIndex: '1',
    expectedResult: "m/44'/1'/0'/0/1",
  },
  {
    partialHdPath: "m/44'/1'/0'/0",
    addressIndex: '1',
    expectedResult: "m/44'/1'/0'/0/1",
  },
  {
    partialHdPath: "m/44'/1'/0'/0/1",
    addressIndex: '1',
    expectedResult: "m/44'/1'/0'/0/1",
  },
  {
    partialHdPath: "m/44'/1'/0'/0/1/0",
    addressIndex: '1',
    expectedResult: "m/44'/1'/0'/0/1/0",
  },
  // AddressIndex 1'
  { partialHdPath: 'm', addressIndex: "1'", expectedResult: "m/44'/505'/0'/0/1'" },
  {
  ...
  {
    partialHdPath: "m/44'/505'/0'/0/0",
    child: true,
    expectedResult: "m/44'/505'/0'/0/0",
  },
  {
    partialHdPath: "m/44'/505'/0'",
    addressIndex: "1'",
  ...
  {
    partialHdPath: "m/44'/1'/0'/0/0'",
    child: true,
    expectedResult: "m/44'/1'/0'/0/0'",
  },
  {
    partialHdPath: "m/44'/1'/0'",
    addressIndex: '1',
  ...
  testItems.forEach(({ partialHdPath, addressIndex, expectedResult, child }) => {
    test(`${
      child
        ...
        : `complete hdPath: "${partialHdPath}" w/${
            addressIndex ? `addressIndex: "${addressIndex}"` : 'o addressIndex'
          }`
    }`, () => {
      expect(completeHdPath(partialHdPath, addressIndex, child)).toBe(
        expectedResult
      );
    });
  });

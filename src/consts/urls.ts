...
// NEW ACCOUNT (ADD/CREATE)
// - CREATE
export const NEW_ACCOUNT_CREATE_TAB_URL = `#${NEW_ACCOUNT_URL}/create`;
export const CREATE_ACCOUNT_SEED_INFO_TAB_URL = `${NEW_ACCOUNT_CREATE_TAB_URL}${NEW_ACCOUNT_SEED_INFO}`;
export const CREATE_ACCOUNT_SEED_VALUE_TAB_URL = `${NEW_ACCOUNT_CREATE_TAB_URL}${NEW_ACCOUNT_SEED_VALUE}`;
export const CREATE_ACCOUNT_SEED_VERIFY_TAB_URL = `${NEW_ACCOUNT_CREATE_TAB_URL}${NEW_ACCOUNT_SEED_VERIFY}`;
export const CREATE_ACCOUNT_PASSWORD_TAB_URL = `${NEW_ACCOUNT_CREATE_TAB_URL}${NEW_ACCOUNT_PASSWORD}`;
export const CREATE_ACCOUNT_SUCCESS_TAB_URL = `${NEW_ACCOUNT_CREATE_TAB_URL}${NEW_ACCOUNT_SUCCESS}`;
// - ADD
export const NEW_ACCOUNT_ADD_TAB_URL = `#${NEW_ACCOUNT_URL}/add`;
export const ADD_ACCOUNT_SEED_INFO_TAB_URL = `${NEW_ACCOUNT_ADD_TAB_URL}${NEW_ACCOUNT_SEED_INFO}`;
export const ADD_ACCOUNT_SEED_VALUE_TAB_URL = `${NEW_ACCOUNT_ADD_TAB_URL}${NEW_ACCOUNT_SEED_VALUE}`;
export const ADD_ACCOUNT_SEED_VERIFY_TAB_URL = `${NEW_ACCOUNT_ADD_TAB_URL}${NEW_ACCOUNT_SEED_VERIFY}`;
export const ADD_ACCOUNT_PASSWORD_TAB_URL = `${NEW_ACCOUNT_ADD_TAB_URL}${NEW_ACCOUNT_PASSWORD}`;
export const ADD_ACCOUNT_SUCCESS_TAB_URL = `${NEW_ACCOUNT_ADD_TAB_URL}${NEW_ACCOUNT_SUCCESS}`;

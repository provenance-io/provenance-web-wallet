...
export const DEFAULT_MAINNET_HD_PATH = `m/44'/${PROVENANCE_WALLET_COIN_TYPE}'/0'`; // m/44'/505'/0' (account level)
export const DEFAULT_TESTNET_HD_PATH = `m/44'/${TESTNET_WALLET_COIN_TYPE}'/0'`; // m/44'/1'/0' (account level)
